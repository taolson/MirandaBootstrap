...
exceptionInfo ::=
    ...
    Occurs         num   texpr       |       || type var n occurs in its substitution (infinite type)
    QualBind       name              |       || qualified name in binding position
    RepeatedTvar   num               |       || type var n used multiple times in a definition
...
showsExceptionInfo (Unreachable p)      = shows "unreachable pattern " . showsAst p
...
isError e = view excptType e == Error

isWarn :: exception -> bool
isWarn e = view excptType e == Warn

isNote :: exception -> bool
isNote e = view excptType e == Note
...
ex_liftA2 f ma mb = ex_fmap f ma $ex_apply mb
